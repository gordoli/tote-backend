...
export class Init1722890333671 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_Users_lower_username" ON "Users" ("username") `);
        await queryRunner.query(`CREATE INDEX "IDX_Users_username" ON "Users" ("username") `);
        await queryRunner.query(`CREATE INDEX "IDX_Users_lower_email" ON "Users" ("email") `);
        await queryRunner.query(`CREATE INDEX "IDX_Users_email" ON "Users" ("email") `);
        await queryRunner.query(`CREATE TABLE "Wishlists" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updatedAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "userId" uuid, "productId" uuid, CONSTRAINT "PK_21379dd460194cf2f2fccda8b2b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_followers_user_follower" ON "Followers" ("userId", "followerId") `);
        ...
        await queryRunner.query(`ALTER TABLE "Wishlists" ADD CONSTRAINT "FK_9c416f3c2826e8ca9fc090ba065" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "Feeds" ADD CONSTRAINT "FK_d7cc6378cb63766a7383aaab601" FOREIGN KEY ("createdBy") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "CustomLists" ADD CONSTRAINT "FK_76b86007263e50c3c8ebaac8f10" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "CustomLists" DROP CONSTRAINT "FK_76b86007263e50c3c8ebaac8f10"`);
        ...
        await queryRunner.query(`ALTER TABLE "Feeds" DROP CONSTRAINT "FK_d7cc6378cb63766a7383aaab601"`);
        await queryRunner.query(`ALTER TABLE "Wishlists" DROP CONSTRAINT "FK_90226d3531177129476a69788ec"`);
        await queryRunner.query(`ALTER TABLE "Wishlists" DROP CONSTRAINT "FK_9c416f3c2826e8ca9fc090ba065"`);
